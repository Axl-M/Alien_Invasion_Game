...
def run_game():
    ...
    # Создание экземпляра для хранения игровой статистики и счёта.
    ...
    # основной цикл игры
    while True:
        gf.check_events(ai_settings, screen, stats, sb, play_button, ship, aliens, bullets)  # проверяет ввод, полученный от игрока
